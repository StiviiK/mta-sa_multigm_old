if DEBUG then
	function Debug.renderInformations ()
		...
		dxSetRenderTarget(Debug.DebugWindow1.renderTarget, true)
			...
			dxDrawText(_"Debug Informationen", 10, 10, 248, 38, tocolor(255, 255, 255, 255), 1.00, "pricedown", "center", "center", true, false, false, false, false)
			dxDrawText(("%s: %s (%s)"):format(_"Client Version", localPlayer.version["tag"], localPlayer.version["type"]), 9, 48, 248, 66, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "center", true, false, false, false, false)
			dxDrawText(("%s: %s"):format(_"Grafikkarte", localPlayer.dxStatus["VideoCardName"]), 9, 76, 248, 94, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "center", true, false, false, false, false)
			dxDrawText(("%s: %s MB"):format(_"vRAM", localPlayer.dxStatus["VideoCardRAM"]), 9, 94, 248, 112, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "center", true, false, false, false, false)
			dxDrawText(("%s: %s MB"):format(_"verfügbare vRAM", localPlayer.dxStatus["VideoMemoryFreeForMTA"]), 9, 112, 248, 130, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "center", true, false, false, false, false)
			dxDrawText(("%s: %s"):format(_"Test Modus", localPlayer.dxStatus["TestMode"]), 9, 130, 248, 148, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "center", true, false, false, false, false)
			dxDrawText(("%s: %s (%s)"):format(_"Byte erhalten", localPlayer.NetworkStats["bytesReceived"], sizeFormat(localPlayer.NetworkStats["bytesReceived"])), 9, 158, 248, 176, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "center", true, false, false, false, false)
			dxDrawText(("%s: %s (%s)"):format(_"Byte gesendet", localPlayer.NetworkStats["bytesSent"], sizeFormat(localPlayer.NetworkStats["bytesSent"])), 10, 176, 249, 194, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "center", true, false, false, false, false)
			dxDrawText(("%s: %s"):format(_"Pakete erhalten", localPlayer.NetworkStats["packetsReceived"]), 9, 194, 248, 212, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "center", true, false, false, false, false)
			dxDrawText(("%s: %s"):format(_"Pakete gesendet", localPlayer.NetworkStats["packetsSent"]), 9, 212, 248, 230, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "center", true, false, false, false, false)
			dxDrawText(("%s: %s%s"):format(_"Pakete verloren", localPlayer.NetworkStats["packetlossTotal"], "%"), 9, 230, 249, 248, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "center", true, false, false, false, false)
		...
		guiSetText(Version.debug_label, ("%s: %s (%s FPS)"):format(_"Debugging-Mode", DEBUG and _("Aktiviert"):lower() or _("Deaktviert"):lower(), math.round(tonumber(localPlayer:getFPS()))))
	end
end