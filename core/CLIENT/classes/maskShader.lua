...
function maskShader:create (image, mask)
	...
	obj.maskTex = dxCreateTexture(mask or "core/FILES/shader/mask/mask_images/mask_round_big.png")
...
function maskShader:update (image, mask)
	...
	if mask ~= false then
		...
		self.maskTex = dxCreateTexture(mask or "core/FILES/shader/mask/mask_images/mask_round.png")
	end
