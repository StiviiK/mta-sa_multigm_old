...
function Playermanager:constructor ()
	...
	self.onGamemodePlayerWasted = bind(self, self.onPlayerDeath)
	...
	addEventHandler("onPlayerWasted", root, self.onPlayerDeath)
end
...
function Playermanager:destructor ()
	...
	removeEventHandler("onPlayerWasted", root, self.onPlayerDeath)
	...
	self.onGamemodePlayerWasted = nil
end
...
function Playermanager:onPlayerDeath ()
	local gamemode = source:getGamemode()
	if gamemode then
		if rawget(gamemode, "onPlayerDeath") then
			rawget(gamemode, "onPlayerDeath")(source:getGamemode(), source)
		end
	end
end